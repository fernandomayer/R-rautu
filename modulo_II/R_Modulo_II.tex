...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{mean}\hlstd{(dados}\hlopt{$}\hlstd{CL)} \hlcom{# ou sum(dados$CL)/length(dados$CL)}
\end{alltt}
\begin{verbatim}
[1] 32.004
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{mean}\hlstd{(dados}\hlopt{$}\hlstd{BD)}
\end{alltt}
\begin{verbatim}
[1] NA
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{mean}\hlstd{(dados}\hlopt{$}\hlstd{BD,} \hlkwc{na.rm}\hlstd{=T)}
\end{alltt}
\begin{verbatim}
[1] 14.019
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{sd}\hlstd{(dados}\hlopt{$}\hlstd{CL)}
\end{alltt}
\begin{verbatim}
[1] 7.2278
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{var}\hlstd{(dados}\hlopt{$}\hlstd{CL)} \hlcom{# sd(dados$CL)^2}
\end{alltt}
\begin{verbatim}
[1] 52.242
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{sd}\hlstd{(dados}\hlopt{$}\hlstd{CL)}\hlopt{/}\hlkwd{mean}\hlstd{(dados}\hlopt{$}\hlstd{CL)}
\end{alltt}
\begin{verbatim}
[1] 0.22584
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{quantile}\hlstd{(dados}\hlopt{$}\hlstd{CL)}
\end{alltt}
\begin{verbatim}
    0%    25%    50%    75%   100% 
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{quantile}\hlstd{(dados}\hlopt{$}\hlstd{CL,} \hlkwc{probs} \hlstd{=} \hlkwd{seq}\hlstd{(}\hlnum{0}\hlstd{,} \hlnum{1}\hlstd{,} \hlnum{0.1}\hlstd{))}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{summary}\hlstd{(dados}\hlopt{$}\hlstd{CL)}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{summary}\hlstd{(dados}\hlopt{$}\hlstd{BD)}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{summary}\hlstd{(dados)}
\end{alltt}
\begin{verbatim}
    especie   sexo         FL             RW      
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{table}\hlstd{(dados}\hlopt{$}\hlstd{especie)}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{table}\hlstd{(dados}\hlopt{$}\hlstd{especie, dados}\hlopt{$}\hlstd{sexo)}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{apply}\hlstd{(dados[,} \hlnum{3}\hlopt{:}\hlnum{7}\hlstd{],} \hlnum{2}\hlstd{, mean,} \hlkwc{na.rm}\hlstd{=T)}
\end{alltt}
\begin{verbatim}
    FL     RW     CL     CW     BD 
15.577 12.815 32.004 36.310 14.019 
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{tapply}\hlstd{(dados}\hlopt{$}\hlstd{CL,} \hlkwd{list}\hlstd{(dados}\hlopt{$}\hlstd{especie, dados}\hlopt{$}\hlstd{sexo), mean)}
\end{alltt}
\begin{verbatim}
             F      M
azul    28.044 32.176
...
\begin{figure}[htp]
\centering
\includegraphics[height=1\textheight]{figure/fig4m}
\end{figure}
\end{frame}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{plot}\hlstd{(dados}\hlopt{$}\hlstd{CL)}     \hlcom{# uma variável}
\end{alltt}
\end{kframe}

{\centering \includegraphics[width=.7\textwidth]{figure/unnamed-chunk-26} 
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{plot}\hlstd{(dados}\hlopt{$}\hlstd{CL, dados}\hlopt{$}\hlstd{CW)}    \hlcom{# duas variáveis, ou:}
\hlstd{> }\hlkwd{plot}\hlstd{(CW} \hlopt{~} \hlstd{CL,} \hlkwc{data} \hlstd{= dados)} \hlcom{# mesmo resultado}
\end{alltt}
\end{kframe}

{\centering \includegraphics[width=.49\textwidth]{figure/unnamed-chunk-271} 
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{plot}\hlstd{(dados}\hlopt{$}\hlstd{especie, dados}\hlopt{$}\hlstd{CL)}  \hlcom{# fator, numérico}
\end{alltt}
\end{kframe}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{hist}\hlstd{(dados}\hlopt{$}\hlstd{CL)}
\end{alltt}
\end{kframe}

{\centering \includegraphics[width=.7\textwidth]{figure/unnamed-chunk-31} 
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{hist}\hlstd{(dados}\hlopt{$}\hlstd{CL,} \hlkwc{breaks} \hlstd{=} \hlkwd{seq}\hlstd{(}\hlnum{10}\hlstd{,} \hlnum{50}\hlstd{,} \hlnum{1}\hlstd{))} \hlcom{# ou}
\hlstd{> }\hlkwd{hist}\hlstd{(dados}\hlopt{$}\hlstd{CL,} \hlkwc{nclass} \hlstd{=} \hlnum{40}\hlstd{)}             \hlcom{# aproximado}
\end{alltt}
\end{kframe}

{\centering \includegraphics[width=.49\textwidth]{figure/unnamed-chunk-321} 
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{h} \hlkwb{<-} \hlkwd{hist}\hlstd{(dados}\hlopt{$}\hlstd{CL)}
\hlstd{> }\hlstd{h}
\end{alltt}
\begin{verbatim}
$breaks
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{hist}\hlstd{(dados}\hlopt{$}\hlstd{CL)}           \hlcom{# contagem}
\hlstd{> }\hlkwd{hist}\hlstd{(dados}\hlopt{$}\hlstd{CL,} \hlkwc{freq} \hlstd{= F)} \hlcom{# densidade}
\end{alltt}
\end{kframe}

{\centering \includegraphics[width=.49\textwidth]{figure/unnamed-chunk-341} 
...
\end{verbatim}
\begin{alltt}
\hlstd{> }\hlkwd{barplot}\hlstd{(}\hlkwd{table}\hlstd{(dados}\hlopt{$}\hlstd{especie))}
\end{alltt}
\end{kframe}
...
\end{verbatim}
\begin{alltt}
\hlstd{> }\hlkwd{barplot}\hlstd{(}\hlkwd{table}\hlstd{(dados}\hlopt{$}\hlstd{especie, dados}\hlopt{$}\hlstd{sexo))}
\hlstd{> }\hlkwd{barplot}\hlstd{(}\hlkwd{table}\hlstd{(dados}\hlopt{$}\hlstd{especie, dados}\hlopt{$}\hlstd{sexo),} \hlkwc{beside} \hlstd{= T)}
\end{alltt}
\end{kframe}

{\centering \includegraphics[width=.4\textwidth]{figure/unnamed-chunk-361} 
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{plot}\hlstd{(dados}\hlopt{$}\hlstd{CL, dados}\hlopt{$}\hlstd{CW,}
\hlstd{  }     \hlkwc{xlab} \hlstd{=} \hlstr{"Comprimento da carapaça (cm)"}\hlstd{,}
\hlstd{  }     \hlkwc{ylab} \hlstd{=} \hlstr{"Largura da carapaça (cm)"}\hlstd{,}
\hlstd{  }     \hlkwc{main} \hlstd{=} \hlstr{"Relação entre CL e CW"}\hlstd{)}
\end{alltt}
\end{kframe}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{hist}\hlstd{(dados}\hlopt{$}\hlstd{CL,} \hlkwc{main} \hlstd{=} \hlstr{""}\hlstd{,} \hlkwc{xlim} \hlstd{=} \hlkwd{c}\hlstd{(}\hlnum{0}\hlstd{,} \hlnum{60}\hlstd{),}
\hlstd{  }     \hlkwc{xlab} \hlstd{=} \hlstr{"Comprimento da carapaça (cm)"}\hlstd{,}
\hlstd{  }     \hlkwc{ylab} \hlstd{=} \hlstr{"Frequência"}\hlstd{)}
\end{alltt}
\end{kframe}

{\centering \includegraphics[width=.55\textwidth]{figure/unnamed-chunk-38} 
