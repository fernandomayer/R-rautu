...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlnum{5} \hlopt{*} \hlnum{2} \hlopt{-} \hlnum{10} \hlopt{+} \hlnum{7}
\end{alltt}
\begin{verbatim}
[1] 7
\end{verbatim}
\begin{alltt}
\hlstd{> }\hlnum{5} \hlopt{*} \hlnum{2} \hlopt{-} \hlstd{(}\hlnum{10} \hlopt{+} \hlnum{7}\hlstd{)}
\end{alltt}
\begin{verbatim}
[1] -7
\end{verbatim}
\begin{alltt}
\hlstd{> }\hlnum{5} \hlopt{*} \hlstd{(}\hlnum{2} \hlopt{-} \hlnum{10} \hlopt{+} \hlnum{7}\hlstd{)}
\end{alltt}
\begin{verbatim}
[1] -5
\end{verbatim}
\begin{alltt}
\hlstd{> }\hlnum{5} \hlopt{*} \hlstd{(}\hlnum{2} \hlopt{-} \hlstd{(}\hlnum{10} \hlopt{+} \hlnum{7}\hlstd{))}
\end{alltt}
\begin{verbatim}
[1] -75
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{nome}\hlstd{(argumento1, argumento2, ...)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{runif}\hlstd{(n,} \hlkwc{min} \hlstd{=} \hlnum{0}\hlstd{,} \hlkwc{max} \hlstd{=} \hlnum{1}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{runif}\hlstd{(}\hlnum{10}\hlstd{,} \hlnum{1}\hlstd{,} \hlnum{100}\hlstd{)}
\end{alltt}
\begin{verbatim}
 [1] 64.531 70.844 76.653 17.082 13.192 60.164 14.895 97.979
 [9] 91.078 84.326
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{runif}\hlstd{(}\hlnum{10}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{runif}\hlstd{(}\hlkwc{min} \hlstd{=} \hlnum{1}\hlstd{,} \hlkwc{max} \hlstd{=} \hlnum{100}\hlstd{,} \hlkwc{n} \hlstd{=} \hlnum{10}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{runif}\hlstd{(}\hlnum{10}\hlstd{,} \hlkwc{max} \hlstd{=} \hlnum{100}\hlstd{,} \hlkwc{min} \hlstd{=} \hlnum{1}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{sample}\hlstd{(x, size,} \hlkwc{replace} \hlstd{=} \hlnum{FALSE}\hlstd{,} \hlkwc{prob} \hlstd{=} \hlkwa{NULL}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{help.search}\hlstd{(}\hlstr{"palavra"}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{RSiteSearch}\hlstd{(}\hlstr{"palavra"}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{x} \hlkwb{<-} \hlnum{2}\hlstd{; y} \hlkwb{<-} \hlnum{4}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{y} \hlkwb{<-} \hlkwd{runif}\hlstd{(}\hlnum{10}\hlstd{)}
\hlstd{> }\hlstd{y}
\end{alltt}
\begin{verbatim}
 [1] 0.086905 0.045019 0.374282 0.412360 0.091728 0.106902
 [7] 0.398697 0.639019 0.177635 0.163587
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{numerico} \hlkwb{<-} \hlkwd{c}\hlstd{(}\hlnum{10}\hlstd{,} \hlnum{5}\hlstd{,} \hlnum{2}\hlstd{,} \hlnum{4}\hlstd{,} \hlnum{8}\hlstd{,} \hlnum{9}\hlstd{)}
\hlstd{> }\hlstd{numerico}
\end{alltt}
\begin{verbatim}
[1] 10  5  2  4  8  9
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{seq}\hlstd{(}\hlnum{1}\hlstd{,} \hlnum{10}\hlstd{)}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{seq}\hlstd{(}\hlkwc{from} \hlstd{=} \hlnum{1}\hlstd{,} \hlkwc{to} \hlstd{=} \hlnum{10}\hlstd{,} \hlkwc{by} \hlstd{=} \hlnum{2}\hlstd{)}
\end{alltt}
\begin{verbatim}
[1] 1 3 5 7 9
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{seq}\hlstd{(}\hlkwc{from} \hlstd{=} \hlnum{1}\hlstd{,} \hlkwc{to} \hlstd{=} \hlnum{10}\hlstd{,} \hlkwc{length.out} \hlstd{=} \hlnum{15}\hlstd{)}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{rep}\hlstd{(}\hlnum{1}\hlstd{,} \hlnum{10}\hlstd{)}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{rep}\hlstd{(}\hlkwd{c}\hlstd{(}\hlnum{1}\hlstd{,} \hlnum{2}\hlstd{,} \hlnum{3}\hlstd{),} \hlnum{5}\hlstd{)}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{rep}\hlstd{(}\hlkwd{c}\hlstd{(}\hlnum{1}\hlstd{,} \hlnum{2}\hlstd{,} \hlnum{3}\hlstd{),} \hlkwc{each} \hlstd{=} \hlnum{5}\hlstd{)}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{numerico} \hlopt{*} \hlnum{2}
\end{alltt}
\begin{verbatim}
[1] 20 10  4  8 16 18
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{numerico} \hlopt{*} \hlstd{numerico}
\end{alltt}
\begin{verbatim}
[1] 100  25   4  16  64  81
\end{verbatim}
\begin{alltt}
\hlstd{> }\hlstd{numerico} \hlopt{+} \hlkwd{c}\hlstd{(}\hlnum{2}\hlstd{,} \hlnum{4}\hlstd{,} \hlnum{1}\hlstd{)}
\end{alltt}
\begin{verbatim}
[1] 12  9  3  6 12 10
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{numerico} \hlopt{+} \hlkwd{c}\hlstd{(}\hlnum{2}\hlstd{,} \hlnum{4}\hlstd{,} \hlnum{1}\hlstd{,} \hlnum{3}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{class}\hlstd{(numerico)}
\end{alltt}
\begin{verbatim}
[1] "numeric"
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{length}\hlstd{(numerico)}
\end{alltt}
\begin{verbatim}
[1] 6
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{caracter} \hlkwb{<-} \hlkwd{c}\hlstd{(}\hlstr{"brava"}\hlstd{,} \hlstr{"joaquina"}\hlstd{,} \hlstr{"armação"}\hlstd{)}
\hlstd{> }\hlstd{caracter}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{logico} \hlkwb{<-} \hlstd{caracter} \hlopt{==} \hlstr{"armação"}
\hlstd{> }\hlstd{logico}
\end{alltt}
\begin{verbatim}
[1] FALSE FALSE  TRUE
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{logico} \hlkwb{<-} \hlstd{numerico} \hlopt{>} \hlnum{4}
\hlstd{> }\hlstd{logico}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{fator} \hlkwb{<-} \hlkwd{factor}\hlstd{(}\hlkwd{c}\hlstd{(}\hlstr{"alta"}\hlstd{,}\hlstr{"baixa"}\hlstd{,}\hlstr{"baixa"}\hlstd{,}\hlstr{"media"}\hlstd{,}
\hlstd{  }                  \hlstr{"alta"}\hlstd{,}\hlstr{"media"}\hlstd{,}\hlstr{"baixa"}\hlstd{,}\hlstr{"media"}\hlstd{,}\hlstr{"media"}\hlstd{))}
\hlstd{> }\hlstd{fator}
\end{alltt}
\begin{verbatim}
...
\hlstd{> }\hlstd{fator} \hlkwb{<-} \hlkwd{factor}\hlstd{(}\hlkwd{c}\hlstd{(}\hlstr{"alta"}\hlstd{,}\hlstr{"baixa"}\hlstd{,}\hlstr{"baixa"}\hlstd{,}\hlstr{"media"}\hlstd{,}
\hlstd{  }                  \hlstr{"alta"}\hlstd{,}\hlstr{"media"}\hlstd{,}\hlstr{"baixa"}\hlstd{,}\hlstr{"media"}\hlstd{,}\hlstr{"media"}\hlstd{),}
\hlstd{  }                \hlkwc{levels}\hlstd{=}\hlkwd{c}\hlstd{(}\hlstr{"alta"}\hlstd{,}\hlstr{"media"}\hlstd{,}\hlstr{"baixa"}\hlstd{))}
\hlstd{> }\hlstd{fator}
\end{alltt}
\begin{verbatim}
[1] alta  baixa baixa media alta  media baixa media media
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{num.fac} \hlkwb{<-} \hlkwd{as.factor}\hlstd{(numerico)}
\hlstd{> }\hlstd{num.fac}
\end{alltt}
\begin{verbatim}
[1] 10 5  2  4  8  9 
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{num.num} \hlkwb{<-} \hlkwd{as.numeric}\hlstd{(}\hlkwd{as.character}\hlstd{(num.fac))}
\hlstd{> }\hlstd{num.num}
\end{alltt}
\begin{verbatim}
[1] 10  5  2  4  8  9
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{carac.fac} \hlkwb{<-} \hlkwd{as.factor}\hlstd{(caracter)}
\hlstd{> }\hlstd{carac.fac}
\end{alltt}
\begin{verbatim}
[1] brava    joaquina armação 
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{matriz} \hlkwb{<-} \hlkwd{matrix}\hlstd{(}\hlnum{1}\hlopt{:}\hlnum{12}\hlstd{,} \hlkwc{nrow}\hlstd{=}\hlnum{3}\hlstd{,} \hlkwc{ncol}\hlstd{=}\hlnum{4}\hlstd{)}
\hlstd{> }\hlstd{matriz}
\end{alltt}
\begin{verbatim}
     [,1] [,2] [,3] [,4]
...
\end{verbatim}
\begin{alltt}
\hlstd{> }\hlkwd{class}\hlstd{(matriz)}
\end{alltt}
\begin{verbatim}
[1] "matrix"
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{matriz} \hlkwb{<-} \hlkwd{matrix}\hlstd{(}\hlnum{1}\hlopt{:}\hlnum{12}\hlstd{,} \hlkwc{nrow}\hlstd{=}\hlnum{3}\hlstd{,} \hlkwc{ncol}\hlstd{=}\hlnum{4}\hlstd{,} \hlkwc{byrow}\hlstd{=T)}
\hlstd{> }\hlstd{matriz}
\end{alltt}
\begin{verbatim}
     [,1] [,2] [,3] [,4]
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{cbind}\hlstd{(matriz,} \hlkwd{rep}\hlstd{(}\hlnum{99}\hlstd{,} \hlnum{3}\hlstd{))}
\end{alltt}
\begin{verbatim}
     [,1] [,2] [,3] [,4] [,5]
[1,]    1    2    3    4   99
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{rbind}\hlstd{(matriz,} \hlkwd{rep}\hlstd{(}\hlnum{99}\hlstd{,} \hlnum{4}\hlstd{))}
\end{alltt}
\begin{verbatim}
     [,1] [,2] [,3] [,4]
[1,]    1    2    3    4
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{matriz} \hlopt{*} \hlnum{2}
\end{alltt}
\begin{verbatim}
     [,1] [,2] [,3] [,4]
[1,]    2    4    6    8
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{matriz2} \hlkwb{<-} \hlkwd{matrix}\hlstd{(}\hlnum{1}\hlstd{,} \hlkwc{nrow}\hlstd{=}\hlnum{4}\hlstd{,} \hlkwc{ncol}\hlstd{=}\hlnum{3}\hlstd{)}
\hlstd{> }\hlstd{matriz} \hlopt{%*%} \hlstd{matriz2}
\end{alltt}
\begin{verbatim}
     [,1] [,2] [,3]
[1,]   10   10   10
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{rownames}\hlstd{(matriz)} \hlkwb{<-} \hlkwd{c}\hlstd{(}\hlstr{"A"}\hlstd{,}\hlstr{"B"}\hlstd{,}\hlstr{"C"}\hlstd{)}
\hlstd{> }\hlkwd{colnames}\hlstd{(matriz)} \hlkwb{<-} \hlkwd{c}\hlstd{(}\hlstr{"T1"}\hlstd{,}\hlstr{"T2"}\hlstd{,}\hlstr{"T3"}\hlstd{,}\hlstr{"T4"}\hlstd{)}
\hlstd{> }\hlstd{matriz}
\end{alltt}
\begin{verbatim}
  T1 T2 T3 T4
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{lista} \hlkwb{<-} \hlkwd{list}\hlstd{(}\hlkwc{a} \hlstd{=} \hlnum{1}\hlopt{:}\hlnum{10}\hlstd{,} \hlkwc{b} \hlstd{=} \hlkwd{c}\hlstd{(}\hlstr{"T1"}\hlstd{,}\hlstr{"T2"}\hlstd{,}\hlstr{"T3"}\hlstd{,}\hlstr{"T4"}\hlstd{))}
\hlstd{> }\hlstd{lista}
\end{alltt}
\begin{verbatim}
$a
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{lista} \hlkwb{<-} \hlkwd{list}\hlstd{(}\hlkwc{fator} \hlstd{= fator,} \hlkwc{matriz} \hlstd{= matriz)}
\hlstd{> }\hlstd{lista}
\end{alltt}
\begin{verbatim}
$fator
...
\end{verbatim}
\begin{alltt}
\hlstd{> }\hlkwd{length}\hlstd{(lista)}
\end{alltt}
\begin{verbatim}
[1] 2
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{dataFrame} \hlkwb{<-} \hlkwd{data.frame}\hlstd{(}\hlkwc{ano} \hlstd{=} \hlnum{2000}\hlopt{:}\hlnum{2004}\hlstd{,}
\hlstd{  }                        \hlkwc{captura} \hlstd{=} \hlkwd{c}\hlstd{(}\hlnum{32}\hlstd{,} \hlnum{54}\hlstd{,} \hlnum{25}\hlstd{,} \hlnum{48}\hlstd{,} \hlnum{29}\hlstd{))}
\hlstd{> }\hlstd{dataFrame}
\end{alltt}
\begin{verbatim}
   ano captura
1 2000      32
...
\end{verbatim}
\begin{alltt}
\hlstd{> }\hlkwd{class}\hlstd{(dataFrame)}
\end{alltt}
\begin{verbatim}
[1] "data.frame"
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{dataFrame} \hlkwb{<-} \hlkwd{data.frame}\hlstd{(}\hlkwc{numerico} \hlstd{=} \hlkwd{c}\hlstd{(numerico,} \hlnum{NA}\hlstd{,} \hlnum{NA}\hlstd{,} \hlnum{NA}\hlstd{),}
\hlstd{  }                        \hlkwc{fator} \hlstd{= fator)}
\hlstd{> }\hlstd{dataFrame}
\end{alltt}
\begin{verbatim}
  numerico fator
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{perd} \hlkwb{<-} \hlkwd{c}\hlstd{(}\hlnum{3}\hlstd{,} \hlnum{5}\hlstd{,} \hlnum{NA}\hlstd{,} \hlnum{2}\hlstd{)}
\hlstd{> }\hlstd{perd}
\end{alltt}
\begin{verbatim}
[1]  3  5 NA  2
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{any}\hlstd{(}\hlkwd{is.na}\hlstd{(perd))}
\end{alltt}
\begin{verbatim}
[1] TRUE
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{perd} \hlkwb{<-} \hlkwd{c}\hlstd{(}\hlopt{-}\hlnum{1}\hlstd{,}\hlnum{0}\hlstd{,}\hlnum{1}\hlstd{)}\hlopt{/}\hlnum{0}
\hlstd{> }\hlstd{perd}
\end{alltt}
\begin{verbatim}
[1] -Inf  NaN  Inf
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{is.infinite}\hlstd{(perd)}
\end{alltt}
\begin{verbatim}
[1]  TRUE FALSE  TRUE
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{cont} \hlkwb{<-} \hlkwd{c}\hlstd{(}\hlnum{8}\hlstd{,} \hlnum{4}\hlstd{,} \hlnum{NA}\hlstd{,} \hlnum{9}\hlstd{,} \hlnum{6}\hlstd{,} \hlnum{1}\hlstd{,} \hlnum{7}\hlstd{,} \hlnum{9}\hlstd{)}
\hlstd{> }\hlstd{cont}
\end{alltt}
\begin{verbatim}
[1]  8  4 NA  9  6  1  7  9
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{cont[}\hlnum{4}\hlstd{]}
\end{alltt}
\begin{verbatim}
[1] 9
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{cont[}\hlkwd{c}\hlstd{(}\hlnum{1}\hlstd{,} \hlnum{4}\hlstd{,} \hlnum{8}\hlstd{)]}
\end{alltt}
\begin{verbatim}
[1] 8 9 9
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{ind} \hlkwb{<-} \hlkwd{c}\hlstd{(}\hlnum{1}\hlstd{,} \hlnum{4}\hlstd{,} \hlnum{8}\hlstd{)}
\hlstd{> }\hlstd{cont[ind]}
\end{alltt}
\begin{verbatim}
[1] 8 9 9
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{cont[}\hlopt{-}\hlkwd{c}\hlstd{(}\hlnum{1}\hlstd{,} \hlnum{4}\hlstd{,} \hlnum{8}\hlstd{)]}
\end{alltt}
\begin{verbatim}
[1]  4 NA  6  1  7
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{cont[}\hlnum{1}\hlopt{:}\hlnum{5}\hlstd{]}
\end{alltt}
\begin{verbatim}
[1]  8  4 NA  9  6
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{cont[}\hlopt{!}\hlkwd{is.na}\hlstd{(cont)]}
\end{alltt}
\begin{verbatim}
[1] 8 4 9 6 1 7 9
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{cont[}\hlkwd{is.na}\hlstd{(cont)]} \hlkwb{<-} \hlnum{0}
\hlstd{> }\hlstd{cont}
\end{alltt}
\begin{verbatim}
[1] 8 4 0 9 6 1 7 9
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{mat} \hlkwb{<-} \hlkwd{matrix}\hlstd{(}\hlnum{1}\hlopt{:}\hlnum{9}\hlstd{,} \hlkwc{nrow}\hlstd{=}\hlnum{3}\hlstd{)}
\hlstd{> }\hlstd{mat}
\end{alltt}
\begin{verbatim}
     [,1] [,2] [,3]
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{mat[}\hlnum{2}\hlstd{,}\hlnum{3}\hlstd{]}
\end{alltt}
\begin{verbatim}
[1] 8
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{mat[}\hlkwd{c}\hlstd{(}\hlnum{1}\hlstd{,}\hlnum{3}\hlstd{),} \hlkwd{c}\hlstd{(}\hlnum{2}\hlstd{,}\hlnum{3}\hlstd{)]}
\end{alltt}
\begin{verbatim}
     [,1] [,2]
[1,]    4    7
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{lis} \hlkwb{<-} \hlkwd{list}\hlstd{(}\hlkwc{vetor1} \hlstd{=} \hlkwd{c}\hlstd{(}\hlnum{3}\hlstd{,} \hlnum{8}\hlstd{,} \hlnum{7}\hlstd{,} \hlnum{4}\hlstd{),} \hlkwc{vetor2} \hlstd{=} \hlnum{5}\hlopt{:}\hlnum{0}\hlstd{)}
\hlstd{> }\hlstd{lis}
\end{alltt}
\begin{verbatim}
$vetor1
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{lis[[}\hlnum{1}\hlstd{]][}\hlnum{3}\hlstd{]}
\end{alltt}
\begin{verbatim}
[1] 7
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{lis}\hlopt{$}\hlstd{vetor2}
\end{alltt}
\begin{verbatim}
[1] 5 4 3 2 1 0
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{dframe} \hlkwb{<-} \hlkwd{data.frame}\hlstd{(}\hlkwc{col1} \hlstd{=} \hlnum{4}\hlopt{:}\hlnum{1}\hlstd{,} \hlkwc{col2} \hlstd{=} \hlkwd{c}\hlstd{(}\hlnum{2}\hlstd{,}\hlnum{NA}\hlstd{,}\hlnum{5}\hlstd{,}\hlnum{8}\hlstd{))}
\hlstd{> }\hlstd{dframe}
\end{alltt}
\begin{verbatim}
  col1 col2
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{dframe[}\hlnum{2}\hlstd{,}\hlnum{1}\hlstd{]}
\end{alltt}
\begin{verbatim}
[1] 3
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{dframe[,}\hlnum{2}\hlstd{]}
\end{alltt}
\begin{verbatim}
[1]  2 NA  5  8
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{dframe[,}\hlstr{"col2"}\hlstd{]}
\end{alltt}
\begin{verbatim}
[1]  2 NA  5  8
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{dframe[}\hlnum{1}\hlstd{,]}
\end{alltt}
\begin{verbatim}
  col1 col2
1    4    2
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{dframe[}\hlstr{"1"}\hlstd{,]}
\end{alltt}
\begin{verbatim}
  col1 col2
1    4    2
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{dframe}\hlopt{$}\hlstd{col1}
\end{alltt}
\begin{verbatim}
[1] 4 3 2 1
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{dframe}\hlopt{$}\hlstd{col2[}\hlnum{3}\hlstd{]}
\end{alltt}
\begin{verbatim}
[1] 5
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{dframe}\hlopt{$}\hlstd{col2[}\hlkwd{c}\hlstd{(}\hlnum{2}\hlstd{,}\hlnum{4}\hlstd{)]}
\end{alltt}
\begin{verbatim}
[1] NA  8
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{with}\hlstd{(dframe, col1)}
\end{alltt}
\begin{verbatim}
[1] 4 3 2 1
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{dados} \hlkwb{<-} \hlkwd{c}\hlstd{(}\hlnum{5}\hlstd{,} \hlnum{15}\hlstd{,} \hlnum{42}\hlstd{,} \hlnum{28}\hlstd{,} \hlnum{79}\hlstd{,} \hlnum{4}\hlstd{,} \hlnum{7}\hlstd{,} \hlnum{14}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{dados[dados} \hlopt{>} \hlnum{15}\hlstd{]}
\end{alltt}
\begin{verbatim}
[1] 42 28 79
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{dados[dados} \hlopt{>} \hlnum{15} \hlopt{&} \hlstd{dados} \hlopt{<=} \hlnum{35}\hlstd{]}
\end{alltt}
\begin{verbatim}
[1] 28
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{dados} \hlopt{>} \hlnum{15} \hlopt{&} \hlstd{dados} \hlopt{<=} \hlnum{35}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{dados} \hlkwb{<-} \hlkwd{data.frame}\hlstd{(}\hlkwc{ano}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{2001}\hlstd{,}\hlnum{2002}\hlstd{,}\hlnum{2003}\hlstd{,}\hlnum{2004}\hlstd{,}\hlnum{2005}\hlstd{),}
\hlstd{  }                    \hlkwc{captura}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{26}\hlstd{,}\hlnum{18}\hlstd{,}\hlnum{28}\hlstd{,}\hlnum{26}\hlstd{,}\hlnum{NA}\hlstd{),}
\hlstd{  }                    \hlkwc{porto}\hlstd{=}\hlkwd{c}\hlstd{(}\hlstr{"SP"}\hlstd{,}\hlstr{"RS"}\hlstd{,}\hlstr{"SC"}\hlstd{,}\hlstr{"SC"}\hlstd{,}\hlstr{"RN"}\hlstd{))}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{dados[dados}\hlopt{$}\hlstd{ano} \hlopt{==} \hlnum{2004}\hlstd{,]}
\end{alltt}
\begin{verbatim}
   ano captura porto
4 2004      26    SC
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{dados[dados}\hlopt{$}\hlstd{porto} \hlopt{==} \hlstr{"SC"}\hlstd{,]}
\end{alltt}
\begin{verbatim}
   ano captura porto
3 2003      28    SC
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{dados[dados}\hlopt{$}\hlstd{captura} \hlopt{>} \hlnum{20}\hlstd{,} \hlstr{"captura"}\hlstd{]}
\end{alltt}
\begin{verbatim}
[1] 26 28 26 NA
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{dados[dados}\hlopt{$}\hlstd{captura} \hlopt{>} \hlnum{20} \hlopt{& !}\hlkwd{is.na}\hlstd{(dados}\hlopt{$}\hlstd{captura),]}
\end{alltt}
\begin{verbatim}
   ano captura porto
1 2001      26    SP
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{dados[dados}\hlopt{$}\hlstd{captura} \hlopt{>} \hlnum{25} \hlopt{&} \hlstd{dados}\hlopt{$}\hlstd{porto} \hlopt{==} \hlstr{"SP"}\hlstd{,]}
\end{alltt}
\begin{verbatim}
   ano captura porto
1 2001      26    SP
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{subset}\hlstd{(dados, captura} \hlopt{>} \hlnum{25} \hlopt{&} \hlstd{porto} \hlopt{==} \hlstr{"SP"}\hlstd{)}
\end{alltt}
\begin{verbatim}
   ano captura porto
1 2001      26    SP
