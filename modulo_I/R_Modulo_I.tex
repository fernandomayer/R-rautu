...
\author[CBO 2014]{Fernando de Pol Mayer\inst{1} \and %\url{fernandomayer@gmail.com} \and
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{matriz2} \hlkwb{<-} \hlkwd{matrix}\hlstd{(}\hlnum{1}\hlstd{,} \hlkwc{nrow} \hlstd{=} \hlnum{4}\hlstd{,} \hlkwc{ncol} \hlstd{=} \hlnum{3}\hlstd{)}
\hlstd{matriz} \hlopt{%*%} \hlstd{matriz2}
\end{alltt}
\begin{verbatim}
     [,1] [,2] [,3]
[1,]   10   10   10
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{rownames}\hlstd{(matriz)} \hlkwb{<-} \hlkwd{c}\hlstd{(}\hlstr{"A"}\hlstd{,}\hlstr{"B"}\hlstd{,}\hlstr{"C"}\hlstd{)}
\hlkwd{colnames}\hlstd{(matriz)} \hlkwb{<-} \hlkwd{c}\hlstd{(}\hlstr{"T1"}\hlstd{,}\hlstr{"T2"}\hlstd{,}\hlstr{"T3"}\hlstd{,}\hlstr{"T4"}\hlstd{)}
\hlstd{matriz}
\end{alltt}
\begin{verbatim}
  T1 T2 T3 T4
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{lis[[}\hlnum{1}\hlstd{]][}\hlnum{3}\hlstd{]}
\end{alltt}
\begin{verbatim}
[1] 7
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{dframe}\hlopt{$}\hlstd{col2[}\hlnum{3}\hlstd{]}
\end{alltt}
\begin{verbatim}
[1] 5
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{dframe}\hlopt{$}\hlstd{col2[}\hlkwd{c}\hlstd{(}\hlnum{2}\hlstd{,}\hlnum{4}\hlstd{)]}
\end{alltt}
\begin{verbatim}
[1] NA  8
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{dados} \hlkwb{<-} \hlkwd{data.frame}\hlstd{(}\hlkwc{ano} \hlstd{=} \hlkwd{c}\hlstd{(}\hlnum{2001}\hlstd{,}\hlnum{2002}\hlstd{,}\hlnum{2003}\hlstd{,}\hlnum{2004}\hlstd{,}\hlnum{2005}\hlstd{),}
                    \hlkwc{captura} \hlstd{=} \hlkwd{c}\hlstd{(}\hlnum{26}\hlstd{,}\hlnum{18}\hlstd{,}\hlnum{28}\hlstd{,}\hlnum{26}\hlstd{,}\hlnum{NA}\hlstd{),}
                    \hlkwc{porto} \hlstd{=} \hlkwd{c}\hlstd{(}\hlstr{"SP"}\hlstd{,}\hlstr{"RS"}\hlstd{,}\hlstr{"SC"}\hlstd{,}\hlstr{"SC"}\hlstd{,}\hlstr{"RN"}\hlstd{))}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{dados[dados}\hlopt{$}\hlstd{ano} \hlopt{==} \hlnum{2004}\hlstd{,]}
\end{alltt}
\begin{verbatim}
   ano captura porto
4 2004      26    SC
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{dados[dados}\hlopt{$}\hlstd{porto} \hlopt{==} \hlstr{"SC"}\hlstd{,]}
\end{alltt}
\begin{verbatim}
   ano captura porto
3 2003      28    SC
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{dados[dados}\hlopt{$}\hlstd{captura} \hlopt{>} \hlnum{20}\hlstd{,} \hlstr{"captura"}\hlstd{]}
\end{alltt}
\begin{verbatim}
[1] 26 28 26 NA
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{dados[dados}\hlopt{$}\hlstd{captura} \hlopt{>} \hlnum{20} \hlopt{& !}\hlkwd{is.na}\hlstd{(dados}\hlopt{$}\hlstd{captura),]}
\end{alltt}
\begin{verbatim}
   ano captura porto
1 2001      26    SP
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{dados[dados}\hlopt{$}\hlstd{captura} \hlopt{>} \hlnum{25} \hlopt{&} \hlstd{dados}\hlopt{$}\hlstd{porto} \hlopt{==} \hlstr{"SP"}\hlstd{,]}
\end{alltt}
\begin{verbatim}
   ano captura porto
1 2001      26    SP
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{subset}\hlstd{(dados, captura} \hlopt{>} \hlnum{25} \hlopt{&} \hlstd{porto} \hlopt{==} \hlstr{"SP"}\hlstd{)}
\end{alltt}
\begin{verbatim}
   ano captura porto
1 2001      26    SP
