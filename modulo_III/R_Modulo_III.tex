...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{hist}\hlstd{(dados}\hlopt{$}\hlstd{CL,} \hlkwc{main} \hlstd{=} \hlstr{""}\hlstd{,} \hlkwc{ylab} \hlstd{=} \hlstr{"Frequência absoluta"}\hlstd{,}
\hlstd{  }     \hlkwc{xlab} \hlstd{=} \hlstr{"Comprimento da carapaça (mm)"}\hlstd{,} \hlkwc{col} \hlstd{=} \hlstr{"grey"}\hlstd{)}
\end{alltt}
\end{kframe}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{t.test}\hlstd{(dados}\hlopt{$}\hlstd{CL,} \hlkwc{mu} \hlstd{=} \hlnum{30}\hlstd{,} \hlkwc{alternative} \hlstd{=} \hlstr{"two.sided"}\hlstd{,}
\hlstd{  }       \hlkwc{conf.level} \hlstd{=} \hlnum{0.95}\hlstd{)}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{teste} \hlkwb{<-} \hlkwd{t.test}\hlstd{(dados}\hlopt{$}\hlstd{CL,} \hlkwc{mu} \hlstd{=} \hlnum{30}\hlstd{,} \hlkwc{alternative} \hlstd{=} \hlstr{"two.sided"}\hlstd{,}
\hlstd{  }                \hlkwc{conf.level} \hlstd{=} \hlnum{0.95}\hlstd{)}
\hlstd{> }\hlkwd{names}\hlstd{(teste)}
\end{alltt}
\begin{verbatim}
...
\end{verbatim}
\begin{alltt}
\hlstd{> }\hlstd{teste}\hlopt{$}\hlstd{statistic}
\end{alltt}
\begin{verbatim}
     t 
3.4627 
\end{verbatim}
\begin{alltt}
\hlstd{> }\hlstd{teste}\hlopt{$}\hlstd{p.value}
\end{alltt}
\begin{verbatim}
[1] 0.00069135
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{t.test}\hlstd{(dados}\hlopt{$}\hlstd{CL,} \hlkwc{mu} \hlstd{=} \hlnum{30}\hlstd{,} \hlkwc{alternative} \hlstd{=} \hlstr{"greater"}\hlstd{,}
\hlstd{  }       \hlkwc{conf.level} \hlstd{=} \hlnum{0.95}\hlstd{)}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{t.test}\hlstd{(dados}\hlopt{$}\hlstd{CL,} \hlkwc{mu} \hlstd{=} \hlnum{30}\hlstd{,} \hlkwc{alternative} \hlstd{=} \hlstr{"less"}\hlstd{,}
\hlstd{  }       \hlkwc{conf.level} \hlstd{=} \hlnum{0.95}\hlstd{)}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{require}\hlstd{(lattice)} \hlcom{# pacote para gráficos avançados}
\hlstd{> }\hlkwd{histogram}\hlstd{(}\hlopt{~}\hlstd{CL} \hlopt{|} \hlstd{especie,} \hlkwc{data} \hlstd{= dados)}
\end{alltt}
\end{kframe}
...
{\centering \includegraphics[width=.33\textwidth]{figure/unnamed-chunk-131} 
\includegraphics[width=.33\textwidth]{figure/unnamed-chunk-132} 
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{cor}\hlstd{(dados}\hlopt{$}\hlstd{CL, dados}\hlopt{$}\hlstd{CW)}
\end{alltt}
\begin{verbatim}
[1] 0.9952
\end{verbatim}
\begin{alltt}
\hlstd{> }\hlkwd{cor.test}\hlstd{(dados}\hlopt{$}\hlstd{CL, dados}\hlopt{$}\hlstd{CW)}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{mean}\hlstd{(dados}\hlopt{$}\hlstd{CL)}
\end{alltt}
\begin{verbatim}
[1] 32.004
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{boxplot}\hlstd{(CL} \hlopt{~} \hlstd{especie,} \hlkwc{data} \hlstd{= dados)}
\hlstd{> }\hlkwd{abline}\hlstd{(}\hlkwc{h} \hlstd{=} \hlkwd{mean}\hlstd{(dados}\hlopt{$}\hlstd{CL),} \hlkwc{lty} \hlstd{=} \hlnum{2}\hlstd{,} \hlkwc{col} \hlstd{=} \hlstr{"red"}\hlstd{,} \hlkwc{lwd} \hlstd{=} \hlnum{2}\hlstd{)}
\end{alltt}
\end{kframe}
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.961}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{summary}\hlstd{(mod)}\hlopt{$}\hlstd{coefficients}
\end{alltt}
\begin{verbatim}
               Estimate Std. Error t value   Pr(>|t|)
...
\end{verbatim}
\begin{alltt}
\hlstd{> }\hlstd{teste}\hlopt{$}\hlstd{estimate}
\end{alltt}
\begin{verbatim}
   mean in group azul mean in group laranja 
               29.869                34.085 
\end{verbatim}
\begin{alltt}
\hlstd{> }\hlkwd{diff}\hlstd{(teste}\hlopt{$}\hlstd{estimate)}
\end{alltt}
\begin{verbatim}
